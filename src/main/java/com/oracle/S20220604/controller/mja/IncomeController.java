...
public class IncomeController {
	...
	public String monthIncome(IncomeVO incomeVO,  Model model) {
		...
		Gson gson = new Gson();
		List<IncomeVO> monthList = incomeService.monthIncome(incomeVO);
	...
	public String yearIncome(IncomeVO incomeVO,  Model model) {
		System.out.println("monthIncome 컨트롤러");		
		int month = incomeVO.getMonth();
		int year  = incomeVO.getYear();
		...
		Gson gson = new Gson();
		List<IncomeVO> monthList = incomeService.yearIncome(incomeVO);
		System.out.println("monthList.size() : "  + monthList.size());
		return gson.toJson(monthList); 
	}
}