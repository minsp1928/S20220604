...
<body>
	<header>
			...
			<form action="searchKeyword">
				<div class="header_middle_searchbar">
					<div class="header_middle_searchbar_underline">
						<input type="text" name="keyword" id="searchbar" value="${keyword }" placeholder="Search" onfocus="this.placeholder=''" onblur="this.placeholder='Search'" >
		...
		<c:choose>
			<c:when test="${sessionId ne null }"><!--user_id가 있다면-->
