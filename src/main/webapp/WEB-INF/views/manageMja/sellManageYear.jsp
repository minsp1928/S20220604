...
<div id="monthChart">
 	...
 	<div id="aa">
		<a href="sellManageYear?month=${month }&year=${year-1}">◀</a><input type="text" name="year" id="Ayear" value="${year }">
		<a href="sellManageYear?month=${month }&year=${year+1}">▶</a>
	 </div>
	 <div id="bb">
	    <a href="sellManageYear?month=${month-1 }&year=${year}">◀</a><input type="text" name="month" id="Amonth" value="${month }">
	    <a href="sellManageYear?month=${month+1 }&year=${year}">▶</a>
	 </div>
