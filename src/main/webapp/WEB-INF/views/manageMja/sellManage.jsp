...
<div class="container">
	<div class="row">
		...
		<div class="col-lg-10">
		<div class="row">	
			<div class="col-8 col-lg-4">매출현황</div><p><p>	 
				<div class="col-4 col-lg-1"><a href="sellManage?month=${month }&year=${year-1}">◀</a></div>
				<div class="col-4 col-lg-2"><input type="text" name="year" id="Ayear" value="${year }"></div>
				<div class="col-4 col-lg-1"><a href="sellManage?month=${month }&year=${year+1}">▶</a></div>
			    <div class="col-4 col-lg-1"><a href="sellManage?month=${month-1 }&year=${year}">◀</a></div>
			    <div class="col-4 col-lg-2"><input type="text" name="month" id="Amonth" value="${month }"></div>
			    <div class="col-4 col-lg-1"><a href="sellManage?month=${month+1 }&year=${year}">▶</a></div>	 	 		 	
		</div>
		<p>
		<div class="row">
